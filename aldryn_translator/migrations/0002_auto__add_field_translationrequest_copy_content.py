...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TranslationRequest.copy_content'
        db.add_column(u'aldryn_translator_translationrequest', 'copy_content',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TranslationRequest.copy_content'
        db.delete_column(u'aldryn_translator_translationrequest', 'copy_content')
